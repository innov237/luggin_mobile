                    ...
                    child: Card(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          if ((requestData['tripData']['offeredKilosTrip'] !=
                                      null &&
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  if ((requestData['isTripOrExpedition'] ==
                                          'trip' &&
                                      authUserData['id'] !=
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return Padding(
                                ...
                                child: Column(
                                  ...
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  children: <Widget>[
                                    if (conversationData[index]['idUser'] !=
                                            authUserData['id'] &&
                                    ...
                                    if (conversationData[index]
                                                ['proposalKilos'] !=
                                            null &&
                                        conversationData[index]['idUser'] !=
                                            authUserData['id']) ...[
                                      buildOfferCard(conversationData, index)
                                    ],
                                  ],
                                ),
                              );
